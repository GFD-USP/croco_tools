"""CROCO equation-of-state diagnostics.

This module is a direct Python/xarray translation of CROCO's ``rho_eos.F``
nonlinear equation of state.  The formulas, constants, and parenthesization
follow the Fortran source intentionally; do not replace them with TEOS-10 or
rearrange the polynomials when CROCO reproducibility is required.
"""
